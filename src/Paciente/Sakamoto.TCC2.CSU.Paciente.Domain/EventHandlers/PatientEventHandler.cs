...
{
    public class PatientEventHandler : INotificationHandler<PatientRegisteredEvent>, INotificationHandler<PatientDeactivatedEvent>, INotificationHandler<PatientUpdatedEvent>
    {
